...
- [x] `http_server_service.dart` — local HTTP server + form config HTML
- [x] `setup_screen.dart` — layar setup pertama kali
- [x] `display_screen.dart` — layar utama fullscreen
- [x] `qr_screen.dart` — layar QR code
...
> App prototype berjalan. Display screen tampil lengkap.
> Belum ditest: QR config flow, running text, mode iqomah.
...
### Pengujian Fitur
- [ ] Test QR code muncul saat tekan tombol select/menu
- [ ] Test scan QR dari HP — form config terbuka di browser
- [ ] Test submit form — display TV update real-time
